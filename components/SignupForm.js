    ...
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white py-8 px-6 sm:px-8 shadow-xl rounded-xl border border-gray-100">
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-walmart-dark-gray mb-2">
              Confirm Password
            </label>
            <div className="relative">
              <input
          ...
          <div className="flex items-start">
            ...
            />
            <label htmlFor="agreeToTerms" className="ml-2 block text-sm text-walmart-dark-gray">
              I agree to the{' '}
              <a href="#" className="text-walmart-blue hover:text-walmart-dark-blue transition-colors cursor-pointer">Terms of Service</a>{' '}
              and{' '}
              <a href="#" className="text-walmart-blue hover:text-walmart-dark-blue transition-colors cursor-pointer">Privacy Policy</a>
            </label>
          </div>
          {errors.agreeToTerms && (
