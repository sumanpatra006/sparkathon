...
export default function LoginHeader() {
  ...
  return (
    <div className="text-center py-8 px-4">
      ...
      <h2 className="text-2xl sm:text-3xl font-bold text-walmart-dark-blue">Welcome Back</h2>
      <p className="mt-2 text-walmart-dark-gray text-sm sm:text-base">Sign in to your Walmart Smart Returns account</p>
    </div>
  );
} 